...
export default function PrivacyPage() {
  return (
    <PageShell width="narrow">
      ...
      <p className="-mt-2 text-sm text-muted-foreground">How Radar handles your Gmail data.</p>

      <Section title="What Radar accesses">
        <p>
          Radar requests the{" "}
          <code className="rounded bg-secondary px-1.5 py-0.5 font-mono text-xs text-foreground">
            gmail.readonly
          </code>{" "}
          scope from Google — read-only access to your mailbox. Radar cannot send email, create
      ...
      <Section title="What's stored, and where">
        <p>
          When you click Sync Gmail, Radar reads message metadata (sender, subject, timestamps, a
      ...
      <Section title="Revoking access">
        <p>
          ...
          dashboard at any time — this revokes Radar&apos;s access token with Google immediately
          and deletes it from Radar&apos;s database. You can also revoke access directly from your{" "}
          <a
